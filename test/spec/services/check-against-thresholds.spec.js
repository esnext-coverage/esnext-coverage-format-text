...
describe('areMetricsAboveThresholds', function () {
  ...
  it('should return true if metrics match thresholds', function () {
    const metrics = {
      statement: {covered: 1, total: 1}, // 1/1 = 100% coverage
      branch: {covered: 1, total: 1}, // 1/1 = 100% coverage
      line: {covered: 1, total: 1}, // 1/1 = 100% coverage
      function: {covered: 1, total: 1} // 1/1 = 100% coverage
    };
    const thresholds = {
      statement: 100,
      branch: 100,
  ...
  it('should return false if all metrics are below thresholds', function () {
    const metrics = {
      statement: {covered: 1, total: 2}, // 1/2 = 50% coverage
      branch: {covered: 1, total: 2}, // 1/2 = 50% coverage
      line: {covered: 1, total: 2}, // 1/2 = 50% coverage
      function: {covered: 1, total: 2} // 1/2 = 50% coverage
    };
    const thresholds = {
      statement: 51,
      branch: 51,
  ...
  it('should return false if any file metric is below thresholds', function () {
    const files = {
      ...
      'b.js': {
        statement: {covered: 1, total: 1}, // 1/1 = 100% coverage
        branch: {covered: 1, total: 1}, // 1/1 = 100% coverage
        line: {covered: 1, total: 2}, // 1/2 = 50% coverage here!
        function: {covered: 1, total: 1} // 1/1 = 100% coverage
      },
      'c.js': {
        statement: {covered: 1, total: 1}, // 1/1 = 100% coverage
        branch: {covered: 1, total: 1}, // 1/1 = 50% coverage
        line: {covered: 1, total: 1}, // 1/1 = 100% coverage
        function: {covered: 1, total: 1} // 1/1 = 100% coverage
      }
    };
